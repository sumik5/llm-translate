...
- 翻訳結果をダウンロードする際のファイル名生成を改善し、元のファイル名をそのまま保持するように変更（タイムスタンプを除去）

## [v1.2.3] - 2025-09-20

### 修正

- 翻訳結果をダウンロードする際に、元のアップロードファイル名が失われる問題を解決

## [v1.2.2] - 2025-09-19

### 変更

- マークダウンのコードブロック処理を改善し、言語識別子の誤配置を防止
- 翻訳時のコードブロック保護機能を強化し、通常テキストが誤ってコードブロック化される問題を修正

### 修正

- EPUBパーサーでコードブロックの閉じタグ前に改行が確実に入るように修正
- 翻訳プロンプトを改善し、コードブロックとテキストの区別を明確化
- 翻訳されたプレースホルダーを正しく復元する処理を追加
- 誤って追加された言語識別子を除去する後処理を実装
